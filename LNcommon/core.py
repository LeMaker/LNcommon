def get_bit_mask(bit_num):
    ...
    >>> bin(LNcommon.core.get_bit_mask(0))
    1
    >>> LNcommon.core.get_bit_mask(1)
    2
    >>> bin(LNcommon.core.get_bit_mask(3))
    '0b1000'
    """
    return 1 << (bit_num)
...
def get_bit_num(bit_pattern):
    ...
    >>> LNcommon.core.get_bit_num(0)
    None
    >>> LNcommon.core.get_bit_num(0b1)
    0
    >>> LNcommon.core.get_bit_num(0b11000)
    3
    """
    if bit_pattern == 0:
        return None
